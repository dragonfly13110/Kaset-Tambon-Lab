    ...
    >
      <Container>
        ...
        <div className="mt-12 grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-16">
          <motion.div variants={textBlockVariants} className="space-y-4 text-slate-300">
          ...
          <motion.div variants={visualBlockVariants} className="relative flex h-64 items-center justify-center rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm md:h-80">
            <div className="absolute inset-0 -z-10 overflow-hidden rounded-3xl" aria-hidden>
              <div className="absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-500/10 blur-2xl" />
            </div>
            
            <motion.div animate={iconAnimation} className="absolute top-8 left-12 grid h-16 w-16 place-items-center rounded-2xl bg-emerald-500/15 text-emerald-300 ring-1 ring-inset ring-emerald-400/20">
              <BookOpen className="h-7 w-7" />
            </motion.div>
            
            <motion.div animate={{...iconAnimation, transition: {...iconAnimation.transition, delay: 0.5}}} className="z-10 grid h-20 w-20 place-items-center rounded-2xl bg-emerald-500/20 text-emerald-200 ring-1 ring-inset ring-emerald-400/25 shadow-lg">
              <ShieldCheck className="h-10 w-10" />
            </motion.div>

            <motion.div animate={{...iconAnimation, transition: {...iconAnimation.transition, delay: 0.2}}} className="absolute bottom-8 right-12 grid h-16 w-16 place-items-center rounded-2xl bg-emerald-500/15 text-emerald-300 ring-1 ring-inset ring-emerald-400/20">
