...
export const Map: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.106 5.553a2 2 0 0 0-1.212.42l-4 4A2 2 0 0 0 8.5 11.212l4 4a2 2 0 0 0 2.828 0l4-4a2 2 0 0 0 0-2.828l-4-4a2 2 0 0 0-1.212-.42z" /><path d="M12 22v-4" /><path d="M20 22v-4" /><path d="m22 12-4-4" /><path d="m6 6-4-4" /><path d="m18 12 4 4" /><path d="m4 22 4-4" /></svg>
);
...
export const Satellite: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 4a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V4Z" /><path d="m11.5 7.5 7 7" /><path d="m7 12-5.5 5.5" /><path d="m21.5 16.5-7-7" /><path d="M9 17a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1Z" /><path d="M18 8a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1Z" /><path d="M15 15.5 12 12l-3.5 3.5" /></svg>
);

export const GooglePlay: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 7.2v9.6c0 .7.5 1.2 1.2 1.2h1.3c.7 0 1.2-.5 1.2-1.2V7.2c0-.7-.5-1.2-1.2-1.2H4.2C3.5 6 3 6.5 3 7.2z" /><path d="M22 12 14.1 3.5" /><path d="m14.1 20.5 7.9-8.5" /><path d="M14.1 12 8.5 7.3" /><path d="M14.1 12 8.5 17" /></svg>
);
...
export const CloudSun: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 16.5V12" /><path d="m14.5 14.5-2-2" /><path d="M17.5 12H15" /><path d="m14.5 9.5 2-2" /><path d="M12 7.5V5" /><path d="m9.5 9.5-2-2" /><path d="M7.5 12H5" /><path d="m9.5 14.5 2 2" /><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" /></svg>
);

export const Droplets: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.48-2.26-1.3-3.05S8.14 8 7 8c-2.2 0-4 1.83-4 4.05S4.8 16.3 7 16.3z" /><path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.52 1.23 1.2 2.37 2.07 3.33a9.23 9.23 0 0 1 3.93 6.65c0 4.23-3.26 7.67-7.24 8.01" /></svg>
);
...
export const BrainCircuit: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v0a4.5 4.5 0 0 0 4.5 4.5v0a4.5 4.5 0 0 0 4.5-4.5v0A4.5 4.5 0 0 0 12 2Z" /><path d="M17 12.5a4.5 4.5 0 0 1-4.5 4.5v0a4.5 4.5 0 0 1-4.5-4.5" /><path d="M17 12.5h2.5" /><path d="M14 17a2.5 2.5 0 0 0 0-5" /><path d="M10 17a2.5 2.5 0 0 1 0-5" /><path d="M6.5 12.5H4" /><path d="M12 11V9" /><path d="M12 17v2" /><path d="M12 21a2.5 2.5 0 0 0 0-5" /><path d="M12 6.5A2.5 2.5 0 0 0 9.5 4" /><path d="M12 6.5A2.5 2.5 0 0 1 14.5 4" /></svg>
);
export const Paintbrush: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17 3a2.85 2.83 0 0 0 4 4L7.5 20.5 2 22l1.5-5.5Z" /><path d="m15 5 4 4" /></svg>
);
...
export const CodeXml: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const Component: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z" /><path d="m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z" /><path d="m18.5 8.5 3.5 3.5-3.5 3.5-3.5-3.5 3.5-3.5Z" /><path d="m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z" /></svg>
);
